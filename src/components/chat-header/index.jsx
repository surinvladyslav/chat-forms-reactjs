...
const ChatHeader = () => {
    const {chatTyping} = useContext();
    return (
        <div className="sidebar-header">
            <div
                className="bubbles-inner"
                style={{maxWidth: '800px'}}
            >
                <div className="sidebar-header-inner">
                    <Link className="btn-icon white" to="/">
                    ...
                    <div className="chat-info">
                        <div className="person">
                            <div className="content">
                                <div className="top">
                                    <span className="peer-title">Ш++</span>
                                </div>
                    ...
                    {/*<Button className={'btn-icon white'} onClick={openDropdown}>*/}
                    {/*    <svg width="4" height="16" viewBox="0 0 4 16" fill="#707579" xmlns="http://www.w3.org/2000/svg">*/}
                    {/*        <path fill="#707579" d="M2 4C3.1 4 4 3.1 4 2C4 0.9 3.1 0 2 0C0.9 0 0 0.9 0 2C0 3.1 0.9 4 2 4ZM2 6C0.9 6 0 6.9 0 8C0 9.1 0.9 10 2 10C3.1 10 4 9.1 4 8C4 6.9 3.1 6 2 6ZM0 14C0 12.9 0.9 12 2 12C3.1 12 4 12.9 4 14C4 15.1 3.1 16 2 16C0.9 16 0 15.1 0 14Z"/>*/}
                    {/*    </svg>*/}
                    {/*</Button>*/}
                    {/*<ChatDropdown className={'dropdown'}>*/}
                    {/*    <div className="compact">*/}
                    {/*        <i className="icon-select"/>Clear chat*/}
                    {/*    </div>*/}
                    {/*    <div className="compact">*/}
