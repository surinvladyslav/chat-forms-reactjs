                        ...
                        <div className="sidebar-left-section-container">
                            <div className="sidebar-left-section no-delimiter">
                                <div className="sidebar-left-section-content">
                                    <Avatar className="profile-avatar" size={'5rem'}>
                                        bot
                                    </Avatar>
                                    <div className="profile-name">
                                        <span className="peer-title">Bot</span>
                                    </div>
                                    {/*<div className="row row-with-icon row-with-padding">*/}
                                    ...
                                    {/*        <div className="row-title tgico tgico-location" dir="auto">Username</div>*/}
                                    {/*        <span className="i18n">Username</span>*/}
                                    {/*    </div>*/}
                                    {/*</div>*/}
                                    {/*<div className="row row-with-icon row-with-padding">*/}
                                    {/*    <svg className="row-icon" xmlns="http://www.w3.org/2000/svg" version="1.0"*/}
                                    ...
                                    {/*    </svg>*/}
                                    {/*    <div className="row-wrapper" dir="auto">*/}
                                    {/*        <div className="row-title tgico tgico-location" dir="auto">Bio</div>*/}
                                    {/*        <span className="i18n">Bio</span>*/}
                                    {/*    </div>*/}
                                    {/*</div>*/}
                                    {/*<div className="row row-with-icon row-with-padding">*/}
                                    {/*    <svg className="row-icon" xmlns="http://www.w3.org/2000/svg" version="1.0"*/}
                                    ...
                                    {/*    </svg>*/}
                                    {/*    <div className="row-wrapper" dir="auto">*/}
                                    {/*        <div className="row-title tgico tgico-location" dir="auto">Location</div>*/}
                                    {/*        <span className="i18n">Location</span>*/}
                                    {/*    </div>*/}
                                    {/*</div>*/}
                                    {/*<div className="row row-with-icon row-with-padding">*/}
                                    {/*    <svg className="row-icon link" xmlns="http://www.w3.org/2000/svg" version="1.0"*/}
                                    {/*         width="344.000000pt" height="344.000000pt"*/}
                                    {/*         viewBox="0 0 344.000000 344.000000" preserveAspectRatio="xMidYMid meet">*/}
                                    {/*        <g transform="translate(0.000000,344.000000) scale(0.100000,-0.100000)"*/}
                                    {/*           fill="#000000" stroke="none">*/}
                                    ...
                                    {/*    </svg>*/}
                                    {/*    <div className="row-wrapper" dir="auto">*/}
                                    {/*        <div className="row-title tgico tgico-location" dir="auto">Link</div>*/}
                                    {/*        <span className="i18n">Link</span>*/}
                                    {/*    </div>*/}
                                    {/*</div>*/}
                                </div>
                            </div>
