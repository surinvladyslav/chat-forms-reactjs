                ...
                <div className="rows-wrapper-wrapper">
                    <div className="rows-wrapper chat-input-wrapper">
                        ...
                        <div className="new-message-wrapper">
                            <Button className={'btn-icon input switch '} onClick={()=> console.log('click')}>
                            ...
                            <Button className={'btn-icon input switch'}>
                                <svg className="tgico tgico-send" xmlns="http://www.w3.org/2000/svg" version="1.0" width="260.000000pt" height="280.000000pt" viewBox="0 0 260.000000 280.000000" preserveAspectRatio="xMidYMid meet">
                                    <g transform="translate(0.000000,280.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                                        <path d="M1270 1950 c-382 -137 -714 -257 -738 -266 -47 -17 -66 -54 -41 -79 8 -8 157 -69 332 -136 l317 -121 62 57 c34 31 222 208 418 394 372 352 442 415 349 316 -31 -33 -217 -230 -413 -438 -196 -208 -356 -382 -356 -387 0 -5 54 -150 120 -322 106 -278 135 -338 161 -338 30 0 65 88 310 774 250 703 262 740 248 765 -10 18 -24 27 -44 28 -18 1 -305 -96 -725 -247z"/>
                                    </g>
                                </svg>

                                <svg className="tgico tgico-microphone" xmlns="http://www.w3.org/2000/svg" version="1.0" width="344.000000pt" height="344.000000pt" viewBox="0 0 344.000000 344.000000" preserveAspectRatio="xMidYMid meet">
                                    <g transform="translate(0.000000,344.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                                        <path d="M1587 3130 c-139 -44 -244 -157 -283 -305 -21 -78 -20 -988 1 -1070 43 -163 182 -288 354 -316 166 -26 346 61 434 212 55 93 57 121 57 644 0 510 -2 531 -50 625 -94 185 -313 274 -513 210z"/>
                                        <path d="M793 1839 c-72 -46 -78 -121 -24 -289 107 -331 376 -576 727 -663 l83 -20 3 -178 c3 -173 4 -178 28 -204 50 -54 114 -69 168 -41 15 8 38 26 52 41 24 26 25 31 28 204 l3 178 88 22 c345 84 617 333 722 661 40 125 47 186 24 233 -46 98 -200 103 -249 9 -8 -16 -22 -60 -31 -98 -52 -227 -239 -430 -470 -511 -73 -25 -92 -27 -225 -27 -132 0 -152 2 -222 27 -235 82 -421 283 -473 511 -9 38 -23 82 -31 98 -34 65 -136 89 -201 47z"/>
                                    </g>
                                </svg>
                            </Button>
