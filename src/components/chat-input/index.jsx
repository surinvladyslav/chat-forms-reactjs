    ...
    return (
        <div className="input-message-wrapper">
            <input
                ...
                onKeyPress={event => event.key === 'Enter' && onClick(event.target.value)}
            />

            <Button
                onClick={() => onClick(inputMessage)}
            >
                <svg style={{width: '1rem', height: 'auto'}} xmlns="http://www.w3.org/2000/svg" version="1.0"
